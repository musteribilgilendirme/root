    ...
    <div id="user-nav" class="navbar navbar-inverse">
        <ul class="nav btn-group">
            ...
            <li class="btn btn-inverse"><a title=""
                href="<c:url value="/logout" />"><i class="icon icon-share-alt"></i>
                    <span class="text"><s:message code="label.logout" /></span></a></li>
        </ul>
    </div>

    <div id="sidebar">
        <a href="${homeUrl}" class="visible-phone"><i
            class="icon icon-home"></i>${lblMainPage}</a>
        <ul>
            <li class="${selectedMenu eq 'HOME' ? 'active' : ''}"><a
                href="${homeUrl}"><i class="icon icon-home"></i><span>${lblMainPage}</span></a></li>


            <li class="${selectedMenu eq 'CUSTOMER' ? 'active' : ''}"><a
                href="${customerHomeUrl}"><i class="icon icon-user"></i><span>${lblCustomer}</span></a></li>


            <li class="${selectedMenu eq 'DEMAND' ? 'active' : ''}"><a
                href="demand"><i class="icon icon-time"></i> <span><s:message
                            code="label.demand" /></span></a></li>
            <li class="${selectedMenu eq 'CALENDAR' ? 'active' : ''}"><a
                href="calenar"><i class="icon icon-calendar"></i> <span><s:message
                            code="label.calendar" /></span></a></li>
            <li class="${selectedMenu eq 'TRANSACTIONS' ? 'active' : ''}"><a
                href="transaction"><i class="icon icon-list"></i> <span><s:message
